...
if (isset($_GET["btnenv"])) {
    ...
    if ($_GET["btnenv"] == 'Guardar') {
        print $DP->getRegistrar(new Categoria($cod, $nom));
        print "<br><input type='button' onclick=location.href='VCategoria.php?bus=Mostrar' value='Continuar'>";
    } else {
        print $DP->getActualizar(new Categoria($cod, $nom));
        print "<br><input type='button' onclick=location.href='VCategoria.php?bus=Mostrar' value='Continuar'>";
    }
}
...
if (isset($_GET['bus'])) {
    print "<input type='button' onclick=getcargarURL('Vistas/VCategoria.php?nue=Nuevo&boton=Guardar') name='tipo' value='Nuevo'><p>";
...
if (isset($_GET['nue']) || isset($_GET['edi'])) {
    ...
    echo "
            ...
            <div class='panel-heading'>".$boton."Categoria</div>
            ...
            <table width='350' align='center'  class='table'>
                ...
                <tr>
                    <td><input type='button' onclick=getOnclickForm('Vistas/VCategoria.php') name='btnenv' id='btnenv' value='" . $boton . "'></td>
                    <td></td>
